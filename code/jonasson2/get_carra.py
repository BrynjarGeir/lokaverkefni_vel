# -*- coding: utf-8 -*-
import numpy as np, datetime, json, pandas as pd, time, cdsapi, pygrib
import tempfile, os
from datetime import datetime, timedelta

def retrieve_specific_time(timestamp, hl, vbs, product_type):#: str, hl: list[str], vbs: list[str], product_type: str):
...
def retrieve_month(vbs, height_levels, product_type, yrmonth, days, hr_list):#: list[str], height_levels: list[int], product_type: str,
...
def read_grib(grib_file, vbs, height_levels, days, hr_list):#: list[str], height_levels: list[int], 
...
file_path = 'carraJSON24klst.json'

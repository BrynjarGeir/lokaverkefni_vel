...
def updateStationToLatLon(dictFilePath: str = "D:/Skóli/lokaverkefni_vel/data/Vedurstofa/isn93StationCoordinates.pkl",
                              strippedFilePath: str = "D:/Skóli/lokaverkefni_vel/data/Vedurstofa/stripped_10min.feather") -> None:

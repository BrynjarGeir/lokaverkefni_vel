...
def findCorrupted():
    featherDirectory = "D:/Skóli/lokaverkefni_vel/data/Carra/StrippedCarra/"
    gribDirectory = "D:/Skóli/lokaverkefni_vel/data/Carra/GRIB/"
    ...
    with open("D:/Skóli/lokaverkefni_vel/data/Carra/need_to_download_again_GRIB.csv", "w") as f:
        writer = csv.writer(f)
...
def callNewGRIB(indices):
    ...
    with open("D:/Skóli/lokaverkefni_vel/data/Carra/need_to_download_again_GRIB.csv", "r") as f:
...
def filterAndShiftNewGRIBToFeatherFiles():
    ...
    npoints_path = "D:/Skóli/lokaverkefni_vel/data/Carra/npoints.pkl"
    npoints = readIndexBool(npoints_path)
    missing_variables_error_stripping_path = "D:/Skóli/lokaverkefni_vel/data/Carra/missing_variables_error_stripping.txt"
...
#changeFileExtension("D:/Skóli/lokaverkefni_vel/data/Carra/GRIB/", ".feather", ".grib")

#filterAndShiftNewGRIBToFeatherFiles()

drop_level_recent_files("D:/Skóli/lokaverkefni_vel/data/Carra/StrippedCarra")
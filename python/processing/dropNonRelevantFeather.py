...
def dropAllNonRelevant(indices, directory = "/mnt/d/skóli/lokaverkefni_vel/data/Carra/CarraStripped/", extension = ".feather"):
...
def dropAllNonRelevantFeather(stationsPath = "/mnt/d/skóli/lokaverkefni_vel/data/Vedurstofa/isn93StationCoordinates.pkl",
                               directory = "/mnt/d/skóli/lokaverkefni_vel/data/Carra/CarraStripped/",
                               filepath = '/mnt/d/skóli/lokaverkefni_vel/data/Carra/StrippedCarra/1993-11-28-18_00.feather'):
    with open(stationsPath, "rb") as f:
        stations = pickle.load(f)
    relevantIndices = findAllRelevantPoints(filepath, "/mnt/d/skóli/lokaverkefni_vel/data/Carra/relevantIndices.pkl", stations)
    nonRelevantIndices = getNonrelevant(relevantIndices, filepath)
    dropAllNonRelevant(nonRelevantIndices)


findAllRelevantPoints('/mnt/d/skóli/lokaverkefni_vel/data/Carra/StrippedCarra/1993-11-28-18_00.feather', "/mnt/d/skóli/lokaverkefni_vel/data/Carra/relevantIndices.pkl")
stationsPath = "/mnt/d/skóli/lokaverkefni_vel/data/Vedurstofa/isn93StationCoordinates.pkl"
with open(stationsPath, "rb") as f:
    stations = pickle.load(f)

...
#    directory_path = '/mnt/d/Skóli/lokaverkefni_vel/data/Carra/StrippedCarra/'
#    main(directory_path)


still_need_to_dwnld = findFilesStillToBeDownloaded("/mnt/d/Skóli/lokaverkefni_vel/data/Carra/StrippedCarra", "/mnt/d/Skóli/lokaverkefni_vel/data/Vedurstofa/stripped_10min.feather")
